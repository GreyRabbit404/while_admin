...
class AddFieldToAllLoops extends StatefulWidget {
  const AddFieldToAllLoops({super.key});

  @override
  State<AddFieldToAllLoops> createState() => _AddFieldToAllLoopsState();
}

class _AddFieldToAllLoopsState extends State<AddFieldToAllLoops> {
  final TextEditingController _fieldContoller = TextEditingController();

  final TextEditingController _valueController = TextEditingController();
  final TextEditingController _typeController = TextEditingController();

  final CollectionReference _collectionRefernce = FirebaseFirestore.instance.collection('loops');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Field to Loops Collection'),
      ),
      body: Padding(
